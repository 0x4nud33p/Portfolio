...
export const metadata: Metadata = {
  ...
  title: {
    default: "Anudeep Avula | Full Stack Developer",
    template: `%s | Anudeep Avula`,
  },
  description: "Anudeep Avula is a Full Stack Developer from India, with expertise in React, Next.js, TypeScript and Node.js. I create modern web applications and have a passion for clean, efficient code. View my portfolio to see my latest projects and technical blog posts.",
  keywords: ["Anudeep Avula", "Full Stack Developer", "React Developer", "Next.js Developer", "TypeScript Developer", "Node.js Developer", "Web Developer India", "Software Engineer"],
  authors: [{ name: "Anudeep Avula" }],
  creator: "Anudeep Avula",
  publisher: "Anudeep Avula",
  alternates: {
    canonical: DATA.url,
  },
  openGraph: {
    title: "Anudeep Avula | Full Stack Developer",
    ...
    url: DATA.url,
    siteName: "Anudeep Avula - Portfolio",
    locale: "en_US",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Anudeep Avula - Full Stack Developer"
      }
    ]
  },
  twitter: {
